...
public class BlockPortal10K extends BlockBreakable
{
	protected BlockPortal10K(int par1, int par2)
	{
            ...
            for (var7 = -1; var7 <= 2; ++var7)
            {
                for (var8 = -1; var8 <= 3; ++var8)
                {
                    ...
                    if (var7 != -1 && var7 != 2 || var8 != -1 && var8 != 3)
                    {
                        ...
                        else if (var10 != 0 && var10 != Mod10K.portalTrigger10K.blockID)
                        {
                            return false;
                        }
                    }
		...
		if(par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null && par5Entity instanceof EntityPlayerMP) 
		{
			if (ModLoader.getMinecraftInstance().thePlayer.timeUntilPortal == 0)
			{
				if (ModLoader.getMinecraftInstance().thePlayer.dimension != Mod10K.dimension10KID)
				{
					...
					MinecraftServer.getServer().getConfigurationManager().transferPlayerToDimension((EntityPlayerMP) par5Entity, Mod10K.dimension10KID, new Teleporter10K());
				}
				else
				{
					ModLoader.getMinecraftInstance().thePlayer.timeUntilPortal = 10;
					MinecraftServer.getServer().getConfigurationManager().transferPlayerToDimension((EntityPlayerMP) par5Entity, 0, new Teleporter10K());
				}
			}
			else
			{
