...
public class Teleporter10K extends Teleporter
{
    ...
    {
        if (par1World.provider.dimensionId != Mod10K.dimension10KID)
        {
    ...
    public boolean placeInExistingPortal(World par1World, Entity par2Entity, double par3, double par5, double par7, float par9)
    {
        ...
        for (var18 = var16 - var10; var18 <= var16 + var10; ++var18)
        {
            ...
            for (int var21 = var17 - var10; var21 <= var17 + var10; ++var21)
            {
                ...
                {
                    if (par1World.getBlockId(var18, var24, var21) == Mod10K.portal10K.blockID)
                    {
                        while (par1World.getBlockId(var18, var24 - 1, var21) == Mod10K.portal10K.blockID)
                        {
                            --var24;
                        }
        ...
        else
        {
            ...
            if (par1World.getBlockId(var13 - 1, var14, var15) == Mod10K.portal10K.blockID)
            {
                var47 = 2;
            }
            ...
            if (par1World.getBlockId(var13, var14, var15 - 1) == Mod10K.portal10K.blockID)
            {
                var47 = 3;
            }
        ...
        for (var20 = 0; var20 < 4; ++var20)
        {
            ...
            for (var21 = 0; var21 < 4; ++var21)
            {
                for (var22 = -1; var22 < 4; ++var22)
                {
                    ...
                    par1World.setBlockWithNotify(var23, var24, var25, var33 ? Block.obsidian.blockID : Mod10K.portal10K.blockID);
                }
            }
