...
import net.minecraft.src.mod_10k;

public class WorldGenFir2 extends WorldGenerator
{
    public WorldGenFir2(boolean par1)
    {
        super(par1);
    }
    ...
    {
        int var6 = par2Random.nextInt(27) + 31;
        int var7 = 1 + par2Random.nextInt(13);
        int var8 = var6 - var7;
        ...
        if (par4 >= 1 && par4 + var6 + 1 <= 256)
        {
            ...
            else
            {
                ...
                if ((var11 == mod_10k.postApoGrass.blockID || var11 == Block.dirt.blockID) && par4 < 256 - var6 - 1)
                {
