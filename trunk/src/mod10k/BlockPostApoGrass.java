...
public class BlockPostApoGrass extends Block
{
	public BlockPostApoGrass(int par1, int i)
	{
        ...
        if (!par1World.isRemote)
        {
            ...
            else if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 9)
            {
                for (int var6 = 0; var6 < 4; ++var6)
                {
                    ...
                    {
                        par1World.setBlockWithNotify(var7, var8, var9, mod_10k.postApoGrass.blockID);
                    }
                }
            }
        }
