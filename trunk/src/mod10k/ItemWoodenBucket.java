            ...
            if (var12.typeOfHit == EnumMovingObjectType.TILE)
            {
                ...
                if (this.isFull == 0)
                {
                    ...
                    if (par2World.getBlockMaterial(var13, var14, var15) == Material.water && par2World.getBlockMetadata(var13, var14, var15) == 0)
                    {
                        ...
                        if (--par1ItemStack.stackSize <= 0)
                        {
                            return new ItemStack(mod_10k.woodenBucketWater);
                        }

                        if (!par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_10k.woodenBucketWater)))
                        {
                            par3EntityPlayer.dropPlayerItem(new ItemStack(mod_10k.woodenBucketWater.shiftedIndex, 1, 0));
                        }
                ...
                else
                {
                    if (this.isFull < 0)
                    {
                        return new ItemStack(mod_10k.woodenBucketEmpty);
                    }
