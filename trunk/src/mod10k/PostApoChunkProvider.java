...
public class PostApoChunkProvider implements IChunkProvider
{
    private Random rand;
    ...
    public PostApoChunkProvider(World par1World, long par2, boolean par4)
    {
